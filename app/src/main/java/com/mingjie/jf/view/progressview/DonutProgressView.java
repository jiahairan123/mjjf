...
public class DonutProgressView extends View {
    ...
    public DonutProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = UnitConversionUtil.sp2px(getContext(),12);
        min_size = (int) UnitConversionUtil.dp2px(getContext(), 100);
        default_stroke_width = UnitConversionUtil.dp2px(getContext(), 10);
        default_inner_bottom_text_size = UnitConversionUtil.sp2px(getContext(), 18);
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedStrokeColor = attributes.getColor(R.styleable.DonutProgressView_donut_finished_color, default_finished_color);
        unfinishedStrokeColor = attributes.getColor(R.styleable.DonutProgressView_donut_unfinished_color, default_unfinished_color);
        textColor = attributes.getColor(R.styleable.DonutProgressView_donut_text_color, default_text_color);
        textSize = attributes.getDimension(R.styleable.DonutProgressView_donut_text_size, default_text_size);

        setMax(attributes.getInt(R.styleable.DonutProgressView_donut_max, default_max));
        setProgress(attributes.getInt(R.styleable.DonutProgressView_donut_progress, 0));
        finishedStrokeWidth = attributes.getDimension(R.styleable.DonutProgressView_donut_finished_stroke_width, default_stroke_width);
        unfinishedStrokeWidth = attributes.getDimension(R.styleable.DonutProgressView_donut_unfinished_stroke_width, default_stroke_width);
        if (attributes.getString(R.styleable.DonutProgressView_donut_prefix_text) != null) {
            prefixText = attributes.getString(R.styleable.DonutProgressView_donut_prefix_text);
        }
        if (attributes.getString(R.styleable.DonutProgressView_donut_suffix_text) != null) {
            suffixText = attributes.getString(R.styleable.DonutProgressView_donut_suffix_text);
        }
        if (attributes.getString(R.styleable.DonutProgressView_donut_text) != null) {
            text = attributes.getString(R.styleable.DonutProgressView_donut_text);
        }
        innerBackgroundColor = attributes.getColor(R.styleable.DonutProgressView_donut_background_color, default_inner_background_color);

        innerBottomTextSize = attributes.getDimension(R.styleable.DonutProgressView_donut_inner_bottom_text_size, default_inner_bottom_text_size);
        innerBottomTextColor = attributes.getColor(R.styleable.DonutProgressView_donut_inner_bottom_text_color, default_inner_bottom_text_color);
        innerBottomText = attributes.getString(R.styleable.DonutProgressView_donut_inner_bottom_text);

        startingDegree = attributes.getInt(R.styleable.DonutProgressView_donut_circle_starting_degree, default_startingDegree);
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if(state instanceof Bundle) {
            ...
            setProgress(bundle.getDouble(INSTANCE_PROGRESS));
