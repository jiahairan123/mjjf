...
import com.mingjie.jf.adapter.Popup2Adapter;
 ...
 * <p>创 建 人： hexiangjun
 * <p>创建时间： 2016-12-27 14:05
 * <p>当前版本： V1.0.0
 * <p>修订历史： (版本、修改时间、修改人、修改内容)
 */
public class PoupupSelect2View implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener
{

    private List<CashBean> mDatas;
    ...
    public PoupupSelect2View(Context mContext, List<CashBean> mDatas, View parent)
    {
        this.mDatas = mDatas;
        this.mParent = parent;
        ...
        mView = inflater.inflate(R.layout.popupwindow_spinner2, null);

    }

    public void setDatas(List<CashBean> mDatas, String title, View mParent)
    {
    ...
    public void showPopupWindow()
    {
        ...
        mListView.setAdapter(new Popup2Adapter(mContext, mDatas, mListView));
        mListView.setOnItemClickListener(this);
        int scaleHeigth = (int) (UIUtils.getScreenY(mContext) * 0.38);
    ...
    {
        void onListItemClick(AdapterView<?> parent,int position, long id);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id)
    {
        if (mListener != null)
        {
            mListener.onListItemClick(parent, position, id);
        }
        mWindow.dismiss();
    }
}
