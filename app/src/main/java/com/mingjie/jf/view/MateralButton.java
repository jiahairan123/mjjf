 ...
 */
public class MateralButton extends Button implements MaterialBackgroundDetector.Callback {
    private MaterialBackgroundDetector mDetector;

    public MateralButton(Context context) {
        super(context);
        init(null, 0);
    }

    public MateralButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public MateralButton(Context context, AttributeSet attrs, int defStyle) {
