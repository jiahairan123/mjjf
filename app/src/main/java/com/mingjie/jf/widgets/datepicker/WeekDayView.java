...
public class WeekDayView extends View {
	//上横线颜色
	private int mTopLineColor = Color.parseColor("#00FFFFFF");
	//下横线颜色
	private int mBottomLineColor = Color.parseColor("#00FFFFFF");
	//周一到周五的颜色
	private int mWeedayColor = Color.parseColor("#aa000000");
	//周六、周日的颜色
	private int mWeekendColor = Color.parseColor("#aa000000");
	//线的宽度
	...
	protected void onDraw(Canvas canvas) {
		...
		for(int i=0;i < weekString.length;i++){
			...
			int startY = (int) (height/2f - (paint.ascent() + paint.descent())/2f);
	...
	public void setWeekString(String[] weekString) {
		this.weekString = weekString.clone();
	}
}
