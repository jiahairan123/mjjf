...
/**
 * 项目名称： CaffcooP2P
 * 包   名：  caffp2p.android.utils
 * 版   权：  深圳市佳科软件科技有限公司 ©2015
 * 描   述：  二维码工具类
 * <p/>
 * 创 建 人： wuxianai
 * 邮箱地址： wuxianai@caffcoo.com
 * 创建时间： 2016/04/27 11:13
 * 当前版本： V3.0.0
...
//            hints.put(EncodeHintType.MARGIN, 2); //default is 4
    ...
    public static Bitmap getQRImage(String content, int widthPix, int heightPix, Bitmap logoBm) {
        try {
            if (content == null || "".equals(content)) {
                return null;
            }
