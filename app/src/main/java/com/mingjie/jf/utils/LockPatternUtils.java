...
public class LockPatternUtils
{
     ...
     *                userName 保存对应用户的手势密码
     */
    public void saveLockPattern(List<LockPatternView.Cell> pattern, String userName)
    {
        if (pattern != null)
        {
            CacheUtils.saveGesturePwd(pattern, userName);
        }
        // Compute the hash
