...
public class CouponActivity extends FragmentActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mTitleDates = getResources().getStringArray(R.array.coupon_tab);
        initView();
        initData();
    }
    ...
    protected void initView()
    {
        ...
        fragmentList.add(CouponListFragment.getInstance(CouponListFragment.TYPE_CASH));
        fragmentList.add(CouponListFragment.getInstance(CouponListFragment.TYPE_RED_PACKET));
    }

    protected void initData()
    {
        tvContentPublic.setText(getString(R.string.coupon_list));
