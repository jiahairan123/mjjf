...
import com.mingjie.jf.fragment.AutoSetFragment;
import com.mingjie.jf.fragment.AutoSetListFragment;
import com.mingjie.jf.fragment.OpenAuthorizationFragment;
 ...
 */
public class AutoInvestActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitleDates = getResources().getStringArray(R.array.auto_invest);
        initView();
        initData();
    ...
    protected void initView() {
        ...
        fragmentList.add(new OpenAuthorizationFragment());
        fragmentList.add(new AutoSetFragment());
        fragmentList.add(new AutoSetListFragment());

    }

    protected void initData() {
        tvContentPublic.setText("自动投资");
    ...
    class MainFragmentPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public int getCount() {
            if (mTitleDates != null) {
                Log.i("123456", "mTitleDates" + mTitleDates.length);
