...
import com.mingjie.jf.fragment.RepayListFragment;
 ...
 */
public class RepayListActivity extends FragmentActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mTitleDates = getResources().getStringArray(R.array.repay_tab);
        initView();
        initData();
    }
    ...
    protected void initView()
    {
        ...
        fragmentList.add(RepayListFragment.getInstance(RepayListFragment.TYPE_ALL));
        fragmentList.add(RepayListFragment.getInstance(RepayListFragment.TYPE_DUE_IN));
        fragmentList.add(RepayListFragment.getInstance(RepayListFragment.TYPE_RECEIVED));
    }

    protected void initData()
    {
        tvContentPublic.setText(getString(R.string.repay_list));
    ...
    public void onClick(View view)
    {
        switch (view.getId())
        {
            ...
            case R.id.iv_right_public:
                startActivity(new Intent(RepayListActivity.this, RepayCalendarActivity.class));
