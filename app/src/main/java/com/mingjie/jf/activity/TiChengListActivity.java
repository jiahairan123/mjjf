...
import com.mingjie.jf.adapter.IntroducedManAdapter;
...
public class TiChengListActivity extends BaseActivity implements View.OnClickListener, RefreshLayout.OnLoadListener, SwipeRefreshLayout.OnRefreshListener {

    private List<IntroducedManBean> datas = new ArrayList<>();
    private IntroducedManAdapter adapter;
    ...
    protected void initView() {
        ...
        adapter = new IntroducedManAdapter(this);
    }
    ...
    private void getData() {
        ...
        HttpManager.getInstance().doPost(ServiceName.CGKX_SHOUYAOQINGREN, params, new HttpCallBack<NewServerResponse<NewBaseListBean<IntroducedManBean>>>() {

            @Override
            public void getHttpCallNull(String str) {
                closeRefresh();
                ToastUtil.showToast(TiChengListActivity.this, getResources().getString(R.string.dataError));
            }

            @Override
            public void getHttpCallBack(NewServerResponse<NewBaseListBean<IntroducedManBean>> rsp) {
                closeRefresh();
                ...
                if (!"000000".equals(rsp.getCode())) {
                    ...
                    ToastUtil.showToast(TiChengListActivity.this, rsp.getMsg());
                }
                if (rsp.getData() == null) {
