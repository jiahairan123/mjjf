...
import com.mingjie.jf.adapter.RepayCalendarAdapter;
import com.mingjie.jf.bean.RepayCalendarDayBean;
import com.mingjie.jf.bean.RepayCalendarMonthBean;
 ...
 * <p>描   述： 还款日历
 * <p>创 建 人： hexiangjun
 * <p>创建时间： 2016-12-15 11:48
 * <p>当前版本： V1.0.0
 * <p>修订历史： (版本、修改时间、修改人、修改内容)
 */
public class RepayCalendarActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, View
        .OnClickListener
{
    ...
    private List<RepayCalendarDayBean> data = new ArrayList<>();
    private RepayCalendarAdapter adapter;
    ...
    protected void initView()
    {
        ...
        initHeader();
        adapter = new RepayCalendarAdapter(this, data);
    ...
    {
        View header = inflater.inflate(R.layout.header_repay_calendar, lvCalendar, false);
        ...
        monthDateView.setThingColor(getResources().getColor(R.color.color_public_green));
        ...
        monthDateView.setDateClick(new MonthDateView.DateClick()
        {
            ...
            public void onClickOnDate()
            {
                ...
                if (day > 0 && day <= DateUtils.getMonthDays(year, month))
                {
                    ...
                    UIUtils.showLoading(RepayCalendarActivity.this);
                    getDayData();
                }
            }
        });
    ...
    private void getMonthData()
    {
        ...
        HttpManager.getInstance().doPost(ServiceName.REPAYMENTPLAN_CALENDAR, params, new
                HttpCallBack<ServerResponse<RepayCalendarMonthBean>>()
                {
                    @Override
                    public void getHttpCallNull(String str)
                    {
                        closeRefresh();
                        ToastUtil.showToast(RepayCalendarActivity.this, getResources().getString(R.string.dataError));
                    }

                    @Override
                    public void getHttpCallBack(ServerResponse<RepayCalendarMonthBean> rsp)
                    {
                        if (rsp == null)
                        {
                            ToastUtil.showToast(RepayCalendarActivity.this, getResources().getString(R.string
                                    .dataError));
                            closeRefresh();
                            return;
                        }
                        if (!"000000".equals(rsp.getCode()) && rsp.getData() == null)
                        {
                            ToastUtil.showToast(RepayCalendarActivity.this, getResources().getString(R.string
                                    .dataError));
                            closeRefresh();
     ...
     * @param bean
     */
    private void showMonthData(RepayCalendarMonthBean bean)
    {
        thingDays.clear();
        thingDays.addAll(bean.getList());

        monthDateView.setDaysHasThingList(thingDays);
        tvReceivable.setText(bean.getSumRepayment()+"");
        tvDuein.setText(StringUtils.dou2Str(bean.getSumAmount()));
    }
    ...
    private void getDayData()
    {
        ...
        Map params = new HashMap(1);
        params.put("startTime", getSelectTime() + "");
        HttpManager.getInstance().doPost(ServiceName.REPAYMENTPLAN_LIST, params, new
                HttpCallBack<ServerResponse<List<RepayCalendarDayBean>>>()
                {
                    @Override
                    public void getHttpCallNull(String str)
                    {
                    ...
                    @Override
                    public void getHttpCallBack(ServerResponse<List<RepayCalendarDayBean>> rsp)
                    {
                        closeRefresh();
                        if (rsp == null)
                        {
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.iv_right_public:
                ...
                startActivity(new Intent(RepayCalendarActivity.this, RepayListActivity.class));
    ...
    {
        CustomerDatePickerDialog pickerDialog = new CustomerDatePickerDialog(RepayCalendarActivity.this,
