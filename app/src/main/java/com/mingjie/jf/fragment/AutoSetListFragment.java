 ...
 * <p>描   述： 自动投资列表
 * <p>创 建 人： qinsiyi
 * <p>创建时间： 2016-09-03 15:54
 * <p>当前版本： V1.0.0
 * <p>修订历史： (版本、修改时间、修改人、修改内容)
 */

public class AutoSetListFragment extends BaseInvestFragment implements RefreshLayout.OnLoadListener, SwipeRefreshLayout.OnRefreshListener, InvestIndicator.OnTabChangeListener, AdapterView.OnItemClickListener {


    @Override
    protected View onLoadSuccessView() {
        View mView = View.inflate(getContext(), R.layout.fragment_auto_invest_list, null);
