 ...
 * <p>描   述： 个人中心 - 我的借款 - 审核中fragment
 * <p>创 建 人： shenfei
 * <p>创建时间： 2016-09-27 17:06
 * <p>当前版本： V1.0.0
 * <p>修订历史： (版本、修改时间、修改人、修改内容)
 */
public class CheckFragment extends BaseInvestFragment implements RefreshLayout.OnLoadListener, SwipeRefreshLayout
        .OnRefreshListener, AdapterView.OnItemClickListener
{
    ...
    protected LoadingPager.LoadedResult onLoadingData()
    {
        ...
        try
        {
            ...
            CheckBean checkBean = (CheckBean) HttpManager.getInstance().doPost(ServiceName.BORROW_PRODUCTINREVIEW,
    ...
    public void getData()
    {
        ...
        HttpManager.getInstance().doPost(ServiceName.BORROW_PRODUCTINREVIEW, params, new HttpCallBack<CheckBean>()
        {
            @Override
